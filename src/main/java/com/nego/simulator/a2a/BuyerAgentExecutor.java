...
public class BuyerAgentExecutor implements AgentExecutor {
    ...
    public void execute(RequestContext ctx, EventQueue eventQueue) throws JSONRPCError {
        ...
        if (sessionId == null || !buyerService.hasSession(sessionId)) {
            String strategyName = (String) meta.getOrDefault("strategy", "AGGRESSIVE");
            ...
            AgentInitRequest initReq = AgentInitRequest.builder()
                    ...
                    .build();
            AgentInitResponse initResp = buyerService.init(initReq);
