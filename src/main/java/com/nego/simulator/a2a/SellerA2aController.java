...
public class SellerA2aController {

    private static final Logger log = LoggerFactory.getLogger(SellerA2aController.class);

    private final AgentCard agentCard;
    private final RequestHandler requestHandler;
    private final ObjectMapper objectMapper;

    public SellerA2aController(AgentCard agentCard, RequestHandler requestHandler, ObjectMapper objectMapper) {
